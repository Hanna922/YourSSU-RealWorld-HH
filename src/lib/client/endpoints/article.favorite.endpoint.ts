...
export const PostArticleFavorite: Endpoint<PostArticleFavoriteRequest, PostArticleFavoriteResponse> = {
    method: 'POST',
...
export const DeleteArticleFavorite: Endpoint<DeleteArticleFavoriteRequest, DeleteArticleFavoriteResponse> = {
    method: 'DELETE',
    path: (p) => `/api/articles/${p.slug}/favorite`,
    pathParams: ['slug'],
}
